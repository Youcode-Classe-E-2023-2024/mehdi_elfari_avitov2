...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE users SET image=?, nom=?, password=? WHERE id=?";

    // Prepare and bind parameters
    $stmt = $con->prepare($sql);
    $stmt->bind_param('sssi', $img, $name, $password, $id);
...
<body>
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <form method="POST" enctype="multipart/form-data" action="edit_profil.php?id=<?php echo $id; ?>">
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Edit Photo</label>
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="col-span-full">
                            <label for="product_title" class="block text-sm font-medium leading-6 text-gray-900">Edit Nom</label>
                            <div class="mt-2">
                                <input type="text" name="nom" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>


                        <div class="sm:col-span-2 sm:col-start-1">
                            <label for="product_price" class="block text-sm font-medium leading-6 text-gray-900">Edit password</label>
                            <div class="mt-2">
